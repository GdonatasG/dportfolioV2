...
import 'application/github_search_bloc/github_search_bloc.dart' as _i11;
import 'application/github_search_bloc/github_search_pagination.dart' as _i10;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i10.GithubSearchPagination>(
      () => _i10.GithubSearchPagination(get<_i5.IGithubRepository>()));
  gh.factoryParam<_i11.GithubSearchBloc, String?, dynamic>((username, _) =>
      _i11.GithubSearchBloc(get<_i10.GithubSearchPagination>(),
          username: username));
  return get;
}

class _$StreamingSharedPreferencesInjectableModule
    extends _i12.StreamingSharedPreferencesInjectableModule {}
