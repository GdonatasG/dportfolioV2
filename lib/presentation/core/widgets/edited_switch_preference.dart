...
class EditedSwitchPreference extends StatefulWidget {
  final Text title;
  final String desc;
  ...
  _EditedSwitchPreferenceState createState() => _EditedSwitchPreferenceState();
}

class _EditedSwitchPreferenceState extends State<EditedSwitchPreference> {
  @override
  void initState() {
    super.initState();
